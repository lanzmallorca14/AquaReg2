...
const getAssetCategory = (record: any): SubType => {
  ...
  if (
    record.isMotorized === true ||
    record.is_motorized === true
  ) {
    return 'motorized';
  }
...
const normalizeRecord = (v: any) => {
  ...
  return {
    ...
    coi: {
      ...
      placeOfInspection:
        coi.place_of_inspection ||
        v.place_of_inspection ||
        v.placeOfInspection ||
        '',
    ...
    /* Fish Number / fishr_number intentionally removed */
...
/* =========================================================
   PRINT RECORD
   COMPLETE COI BASED ON InspectionCOI
========================================================= */
    ...
    .map(
      (doc) => `
        <div class="document-card">
          ...
          <img
            src="${escapeAttribute(doc.value)}"
            alt="${escapeAttribute(doc.name)}"
          />
        </div>
      `
    )
...
<div class="page">
    ...
    <div class="header-top">
      ...
      <div>
        ...
        <div class="office-subtitle">
          Digital Boat Registry
        </div>

        <div class="office-subtitle">
          Department of Agriculture • Romblon
        </div>
      ...
      <div>
        ...
        <div class="document-subtitle">
          MARINE ASSET REGISTRATION RECORD
        </div>
  ...
  <!-- =====================================================
       COI — COMPLETE INSPECTION INFORMATION
  ====================================================== -->
  ...
  <div class="section">
    ...
    <div class="section-title">
      Registered Documents / Requirements
    </div>
    ...
    ${
      ...
      `
        : `
      <div class="field">
        No uploaded document images available.
      </div>
      `
    }
  ...
  <div class="footer">
    ...
    AQUA REG • DIGITAL BOAT REGISTRY •
    DEPARTMENT OF AGRICULTURE • ROMBLON
    ...
    This document is a system-generated record.
    Verify the official record through the AquaReg system.
...
`;
  ...
  if (!printWindow) {
    toast.error(
      ...
      {
        description:
          'Please allow pop-ups for AquaReg and try again.',
      }
    );
...
export default function RecordsPage() {
  ...
  const handleDeleteRecord = (
    ...
    toast.success(
      ...
      {
        description:
          `${name} (${id}) was removed from the registry.`,
      }
    );
    ...
    useMemo(() => {
      return Vessels
        ...
        .filter((v: any) => {
           ...
           * Inspector filtering.
           *
           * Only users whose actual role is
           * inspector are restricted to their
           * inspected records.
           */
  ...
  const handleSubmit = (
    ...
    if (
      ...
      toast.error(
        ...
        {
          description:
            'Please enter at least the vessel/asset name and owner name.',
        }
      );
    ...
    toast.success(
      ...
      {
        description:
          `New asset registered under ${newId}`,
      }
    );
    ...
    <div className="fixed inset-0 z-[120] flex justify-end">
      ...
      <div className="relative w-full max-w-2xl bg-white h-full shadow-2xl p-8 overflow-y-auto">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              >
                ...
                <option value="pangulong">
                  Pangulong
                </option>

                <option value="fishing-gear">
                  Fishing Gear
                </option>

                <option value="payao-balsa">
                  Payao / Balsa
                </option>
          ...
          <SectionTitle
            title="Document Attachments (Images)"
          />
      ...
      <div className="relative aspect-[4/3] rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50 flex items-center justify-center overflow-hidden group hover:border-blue-400 transition-colors">
        ...
        {imageSrc ? (
          ...
          <label className="flex flex-col items-center justify-center cursor-pointer w-full h-full p-2 text-center">
            ...
            <Upload
              size={20}
              className="text-slate-400 mb-1 group-hover:text-blue-600 transition-colors"
            />
...
function DetailView({
  ...
  const handleSave = () => {
    ...
    toast.success(
      ...
      {
        description:
          'Client and asset particulars synchronized.',
      }
    );
  };

  const docs =
    normalizedRecord.requirements ||
  ...
  const barangayClearanceImg =
    docs.barangayClearance ||
    docs.barangay_clearance ||
    normalizedRecord.barangay_clearance ||
    null;

  const cedulaImg =
    docs.cedula ||
    normalizedRecord.cedula ||
    null;

  const validIdImg =
    docs.validID ||
    docs.valid_id ||
    normalizedRecord.valid_id ||
    null;

  const marinaPermitImg =
    docs.marina_permit ||
    docs.marinaPermit ||
    normalizedRecord.marina_permit ||
    null;

  const bfarPermitImg =
    docs.bfar_permit ||
    docs.bfarPermit ||
    normalizedRecord.bfar_permit ||
    null;
  ...
  return (
    <div className="space-y-8 animate-in slide-in-from-right duration-500 pb-20 relative">
      ...
      <header className="bg-white rounded-[2.5rem] border border-slate-200 p-10 flex flex-col md:flex-row gap-10 items-center shadow-sm relative overflow-hidden">
        ...
        <Ship
          size={240}
          className="absolute -right-10 top-0 opacity-[0.05] text-blue-600"
        />
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8">
              ...
              <InfoRow
                ...
                value={
                  coi.certificate_no ||
                  normalizedRecord.certificateNo
                }
                icon={
                  <BadgeCheck
                    size={14}
              ...
              <InfoRow
                ...
                value={
                  coi.engine_serial ||
                  normalizedRecord.engine.serial
                }
                icon={
                  <Hash
                    size={14}
...
const SectionTitle = ({
  ...
  <p className="text-[10px] font-black text-blue-600 uppercase tracking-widest border-b pb-2">
  ...
  <div className="flex justify-between items-center p-4 bg-slate-50 rounded-2xl border">
    ...
    <div className="flex items-center gap-3">
      ...
      <div>
        ...
        <p className="text-xs font-black uppercase italic text-slate-900 leading-none">
